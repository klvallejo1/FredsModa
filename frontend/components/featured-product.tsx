...
const FeaturedProducts = () => {
  ...
  return (
    <div className="max-w-6xl py-4 mx-auto sm:py-16 sm:px-24">
      <h3 className="px-6 text-3xl sm:pb-8">PRODUCTOS RECIENTES</h3>
      <Carousel>
                    ...
                    <Card className="py-4 border-gray-200 shadow-none">
                      ...
                      <div className="flex justify-between gap-4 px-8">
                        ...
                        <div className="flex items-center justify-between gap-3">
                          <p className="px-2 py-1 text-white bg-black rounded-full dark:bg-white dark:text-black w-fit">{size}</p>
